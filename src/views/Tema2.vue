        ...
        .col-lg-10
          AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta bg6")(data-aos="fade-left")
            ...
            .row.justify-content-center.align-items-start(titulo="Teoría cognitiva de la personalidad")
              .col-7
                P Plantea que la conducta está dirigida por la manera como se piensa y se actúa frente a alguna determinada situación; sin embargo, no deja de lado los estímulos que ofrece el ambiente inmediato ante cualquier situación (Montaño et al., 2009, p. 96).
              .col-4
